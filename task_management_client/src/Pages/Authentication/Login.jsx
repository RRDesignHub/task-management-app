    ...
    <div className="min-h-screen flex justify-center items-center bg-background">
      <div className="w-full max-w-md px-6 py-8 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="w-full px-6 py-3 text-white font-medium tracking-wide capitalize bg-primary rounded-lg hover:bg-chocolate transition focus:outline-none focus:ring focus:ring-chocolate"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="flex justify-center">
          <Link
            to="/"
            className="text-sm text-textDark border border-primary font-heebo hover:underline bg-background px-14 py-3 rounded-lg"
          >
            Go to Home
          </Link>
        </div>
